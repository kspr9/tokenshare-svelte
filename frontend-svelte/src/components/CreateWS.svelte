<script lang="ts">
  ...
  let workspaceType: "Business" | "Personal" = "Business";
  let companyName: string = "";
  let regNumber: number | null = null;
  let maxNumberOfShares: number | null = null;
  //let companyType: "Business" | "Personal" = "Business";
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (workspaceType === "Business") {
        let companyType = workspaceType;
        let governanceType = workspaceType;
        const companyDetails = {
          "company_type": companyType,
          "name": companyName,
          "reg_number": regNumber,
          "max_number_of_shares": maxNumberOfShares
        };
        ...
        const requestBody = {
          ...
          governance_contract_data: contractDetails,
        };
...
<form on:submit|preventDefault={handleSubmit}>
  ...
  <div class="form-section">
    ...
    <select id="workspaceType" bind:value={workspaceType}>
  ...
  <div class="form-section">
    ...
    <textarea id="workspaceDescription" bind:value={workspaceDescription}
    ></textarea>
  </div>
  ...
  <div class="form-section">
    ...
    <input type="text" id="adminAddress" bind:value={adminAddress} />
  </div>
